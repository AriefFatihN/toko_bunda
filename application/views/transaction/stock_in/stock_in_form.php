...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <h6 class="font-weight-bolder mb-0 mt-0">Kelola Barang Masuk</h6>
        </nav>
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col">
                            <h6>Data Produk Masuk</h6>
                        </div>
                        <div class="col">
                            <div class="float-end">
                                <a class="btn btn-sm bg-gradient-primary" href="<?= site_url('stock/in') ?>">Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mini-ml">
                        <form action="<?= site_url('stock/process') ?>" method="post">
                            ...
                            <div class="row align-items-center mb-2">
                                <div class="col">
                                    <label>Detail</label>
                                    <input type="text" name="detail" id="detail" class="form-control" placeholder="Restock / Tambahan" required>
                                </div>
                                <div class="col-4">
                            ...
                            <div class="row align-items-center mb-2">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="qty" class="form-control" placeholder="Jumlah Stok Yang Masuk" required>
                                        <span class="input-group-text">Pcs</span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group pt-3">
                                ...
                                <button type="submit" class="btn btn-sm bg-gradient-primary no-mb submit" name="in_add">Konfirmasi Tambah Stok</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pilih Item Barang Masuk</h5>
